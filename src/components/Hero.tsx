    ...
    <div className="flex flex-col gap-8 justify-center">
      ...
      <div className="flex flex-col md:flex-row gap-2 items-start md:items-center justify-between">
        <div className="flex flex-col sm:flex-row min-md:flex-col min-lg:flex-row gap-2 w-full">
          ...
          <button className="w-fit max-lg:w-full self-start bg-zinc-400 text-white border-0 hover:scale-[102%] duration-300 ease-in-out transition-all gap-2 flex items-center justify-center">
...
const Hero = ({
  ...
  return (
    <div className="md:min-h-[400px] px-12">
      <div className="grid md:grid-cols-2 max-md:grid-rows-2 gap-12 h-full">
        {variant === 'primary' ? (
          <>
            <Image/>
            <Text/>
